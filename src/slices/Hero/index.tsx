...
import { InteractiveSkateboard } from "./InteractiveSkateboard-test";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 mx-auto mt-24 max-w-6xl grid grid-rows-[1fr,auto] place-items-end px-6 ~py-10/16">
        ...
        <div className="flex relative w-full flex-col lg:flex-row items-center justify-between ~gap-2/4">
